...
struct CalculatorBrain {
    ...
    var memoryBrain:[MemoryCalculatorBrain] = []
    ...
    mutating func performOperation(_ symbol: String) {
        ...
        if let operation = operations[symbol] {
            ...
            case .equal:
                ...
                if  (userIsTypingM == false || memoryBrain[memoryBrain.endIndex-1].mButton == Constants.MemoryButton.atFirstOperand) || memoryBrain.last?.unaryFunction == nil {
